...
mean_=[730.65487572  35.59751434   5.14613337  27.86261631];
std_=[4.59565912e+04 2.10900147e+02 2.34331624e+00 4.32227478e+00];
for i=1:4
...
Test= x_norm(1)*W1(1,4)+x_norm(2)*W1(2,4)+x_norm(3)*W1(3,4)+x_norm(4)*W1(4,4)
